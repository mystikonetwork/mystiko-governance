...
import { ERC20, ERC20__factory, MystikoVoteToken, MystikoVoteToken__factory } from './typechain/governance';

export type SupportedContractType = ERC20 | MystikoVoteToken;
