...
} from '../../../../../../lib/openzeppelin-contracts/contracts/governance/extensions/GovernorCountingSimple';
...
export class GovernorCountingSimple__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): GovernorCountingSimple {
    return new Contract(address, _abi, signerOrProvider) as GovernorCountingSimple;
  }
}
