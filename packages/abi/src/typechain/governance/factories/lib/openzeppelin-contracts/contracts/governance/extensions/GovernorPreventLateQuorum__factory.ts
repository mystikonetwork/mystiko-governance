...
import type {
  ...
  GovernorPreventLateQuorumInterface,
} from '../../../../../../lib/openzeppelin-contracts/contracts/governance/extensions/GovernorPreventLateQuorum';
...
export class GovernorPreventLateQuorum__factory {
  static readonly abi = _abi;
  static createInterface(): GovernorPreventLateQuorumInterface {
    return new utils.Interface(_abi) as GovernorPreventLateQuorumInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): GovernorPreventLateQuorum {
    return new Contract(address, _abi, signerOrProvider) as GovernorPreventLateQuorum;
  }
}
