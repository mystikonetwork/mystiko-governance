...
export interface MystikoTimelockControllerInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, BytesLike, BytesLike, BytesLike, BigNumberish],
  ): string;
  encodeFunctionData(
...
export interface MystikoTimelockController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MystikoTimelockControllerInterface;
  ...
  estimateGas: {
    ...
    updateDelay(newDelay: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  };
