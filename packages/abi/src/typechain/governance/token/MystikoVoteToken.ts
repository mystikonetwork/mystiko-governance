...
export interface MystikoVoteTokenInterface extends utils.Interface {
  functions: {
...
export interface MystikoVoteToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MystikoVoteTokenInterface;
  ...
  functions: {
    ...
    delegate(delegatee: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    delegate(delegatee: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
