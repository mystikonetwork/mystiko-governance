...
export interface MockMystikoTokenInterface extends utils.Interface {
  functions: {
...
export interface MockMystikoToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMystikoTokenInterface;
